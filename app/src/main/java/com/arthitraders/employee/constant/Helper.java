...
public class Helper {
    ...
    public static String login_url              = "https://treevibestech.com/ats/api/emp_login.php";
    public static String userlist_url           = "https://treevibestech.com/ats/api/user_lists.php";
