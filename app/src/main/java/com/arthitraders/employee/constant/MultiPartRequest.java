package com.arthitraders.employee.constant;
...
public class MultiPartRequest extends Request<String> {
    ...
    public MultiPartRequest(Response.ErrorListener errorListener, Response.Listener listener, ArrayList<File> file, int numberOfFiles, String amount, String transactionid, String transactionmode, String user_id, String dol_emp_id) {
        super(Method.POST, Helper.payment_url, errorListener);
        mListener = listener;
        mHttpEntity = buildMultipartEntity(file, numberOfFiles, amount, transactionid, transactionmode, user_id, dol_emp_id);
    }

    private HttpEntity buildMultipartEntity(ArrayList<File> file, int numberOffiles, String amount, String transactionid, String transactionmode, String user_id, String dol_emp_id) {
        ...
        try {
            ...
            builder.addTextBody("emp", dol_emp_id);
