...
import com.arthitraders.employee.constant.MultiPartRequest;
import com.arthitraders.employee.constant.StringParser;
import com.arthitraders.employee.constant.Template;
...
public class PaymentMethodScreen extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener {
    ...
    TextView title, payment_mode, payment_balance, balance_date;
    LinearLayout cod, cheque, online;
    SwipeRefreshLayout swipelayout;
    String dol_user_id,dol_emp_id, transactionid = "Nill", str_uri="";
    EditText pay_amount;
    Button pay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dol_emp_id= Helper.sharedpreferences.getString("dol_emp_id", "");
...
/// balance
    ...
    private void paymentRequest() {
        try {
            ...
            }, mFile, mFile.size(), pay_amount.getText().toString().trim(), transactionid, payment_mode.getText().toString(), dol_user_id,dol_emp_id);
